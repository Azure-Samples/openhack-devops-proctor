...
if [[ -z "$jenkinsURL" ]]; then
    ...
    az vm extension set --publisher Microsoft.Azure.Extensions --version 2.0 --name CustomScript --vm-name oguzpjentest --resource-group oguzpjentest --protected-settings "{\"fileUris\": [\"https://raw.githubusercontent.com/Azure-Samples/openhack-devops-proctor/jenkins-security/provision-team/configure_jenkins.sh\"], \"commandToExecute\": \"./configure_jenkins.sh $jenkinsVMPassword\"}"