...
usage() { echo "Usage: provision_sql_mobileapp.sh -g <resourceGroupName> -l <resourceGroupLocation> -s <sqlServerName> -k <keyVaultName> -u <sqlServerUsername> -p <sqlServerPassword> -d <sqlDBName>" 1>&2; exit 1; }
...
(
	...
	--service-objective S4 --collation 'SQL_Latin1_General_CP1_CI_AS'
)
