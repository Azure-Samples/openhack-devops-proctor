...
declare RGSUFFIX=""
declare ACRNAME=""
declare -r GITOHTEAMURI="https://github.com/KitSkin/openhack-devops-team.git"
declare -r GITOHTEAMDIRNAME="openhack-devops-team"
declare -r GITOHTEAMBRANCH="openhack_refresh"
declare -r GITOHPROCTORURI="https://github.com/KitSkin/openhack-devops-proctor.git"
declare -r GITOHPROCTORDIRNAME="openhack-devops-proctor"
declare -r GITOHPROCTORBRANCH="openhack_refresh"
